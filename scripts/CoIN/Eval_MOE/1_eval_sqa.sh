...
if [ ! -n "$2" ] ;then
    MODELPATH='./Checkpoints/LLaVA/CoIN/MoE_LoRA/ScienceQA/llava-1.5-7b-moe_lora'
else
    MODELPATH=$2
fi
...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.CoIN.model_vqa_science \
        ...
        --question-file ../../dataset/CoIN/Instructions_Refined/Instructions_Origin/ScienceQA/test.json \
...
python llava/eval/CoIN/eval_science_qa.py \
    --base-dir ../../dataset/CoIN/CL_dataset/ScienceQA \
