...
deepspeed --include localhost:0,1 --master_port 29600 llava/train/train_mem_MOE.py \
    ...
    --previous_task_model_path ./Checkpoints/LLaVA/CoIN/MoE_LoRA/4_Expert/ImageNet/llava-1.5-7b-moe_lora \
    --version $PROMPT_VERSION \
    --data_path ../../dataset/CoIN/Instructions_Refined/Instructions_Origin/GQA/train.json \
    ...
    --bf16 True \
    --output_dir ./Checkpoints/LLaVA/CoIN/MoE_LoRA/4_Expert/GQA/llava-1.5-7b-moe_lora \
    --num_train_epochs 1 \
