...
def eval_model(args):
    ...
    for i, line in enumerate(tqdm(questions)):
        ...
        #         stopping_criteria=stopping_criteria,
        #     )
        #     torch.cuda.synchronize()  # 仅在这里同步一次，为了获取准确的总时长
        #     t1 = time.time()
        # # 计算生成的 Token 数量
        ...
        # # 性能指标计算
        # total_time = t1 - t0
        # tokens_per_sec = num_new_tokens / total_time if total_time > 0 else 0
        # ms_per_token = (total_time / num_new_tokens) * 1000 if num_new_tokens > 0 else 0
        # print(f"\n[Performance Report]")
